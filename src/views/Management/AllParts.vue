    ...
    <div class="box" style="width: 95%;margin: auto;margin-top: 10px;">
        ...
        <el-table :data="tableData" :cell-class-name="rowClass" style="width:100%">
            ...
            <el-table-column align='center' :label="$t('Lang.Views.Manage.All_Parts.Comments')" prop="product_command">
                <template slot-scope="scope">
                    <el-tooltip effect="dark" :content="scope.row.product_command" placement="top-start">
                        <div v-if="scope.row.editAdd" class="command">{{scope.row.product_command}}</div>
                    </el-tooltip>
        ...
        <el-form :model="addParts" :rules= "rules" label-position="right" label-width="105px">
          ...
          <el-form-item :label="$t('Lang.Views.Manage.All_Parts.ProductName')" prop= "product_name" :label-width="formLabelWidth">
            <el-col :span="11">
          ...
          <el-form-item label="Armory" prop= "product_owner" :label-width="formLabelWidth">
            <el-col :span="11">
...
export default {
    ...
    methods: {
        ...
        getAllParts(page, prop, search) {
            Api.getParts({page, prop, search, type: 'admin'}).then((res) => {
